...
public class HospitalApiController {
    ...
    public Result item(
        ...
        return Result.ok(hospitalService.showByhoscode(hoscode));
    }
    ...
    @ApiOperation(value = "获取医院科室名称")
    @GetMapping("inner/getDeptName/{hoscode}/{depcode}")
    public String getDepName(
            @ApiParam(name = "hoscode", value = "医院id", required = true)
            @PathVariable("hoscode") String hoscode,
            @ApiParam(name = "depcode", value = "科室Id", required = true)
            @PathVariable("depcode") String depcode) {
        return departmentService.getDeptName(hoscode,depcode);
    }
