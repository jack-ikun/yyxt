...
import com.kun.user.mapper.UserInfoMapper;
...
import com.kun.enums.AuthStatusEnum;
...
public class UserInfoServiceImpl extends ServiceImpl<UserInfoMapper,UserInfo> implements UserInfoService {
    ...
    public Map<String, Object> login(LoginVo loginVo) {
        ...
        //校验校验验证码
        String modelCode  =redisTemplate.opsForValue().get(phone);
        if(!code.equals(modelCode)){
            throw new MyYyxtException(ResultCodeEnum.CODE_ERROR);
        }
        ...
        if(null == userInfo) {//注册
            ...
            userInfo.setName(phone.substring(0,3)+"*****"+phone.substring(phone.length()-3));
        ...
        if(userInfo.getStatus() == 0) {
            throw new MyYyxtException(ResultCodeEnum.LOGIN_DISABLED_ERROR);
        }
